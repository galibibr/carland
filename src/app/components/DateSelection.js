      ...
      <div className="relative flex-1">
        ...
        <Menu.Button
          ...
          <div className="flex flex-col xl:flex-row items-center xl:gap-x-2 gap-y-2 xl:gap-y-0">
            ...
            <div className="text-[15px] uppercase font-bold">Select Data</div>
          </div>
        ...
        {/* menu */}
        <Menu.Items
          className={`dropdown-menu shadow-lg absolute -top-96 xl:top-[90px] left-1/2 xl:left-0 z-50 transform -translate-x-1/2 xl:-translate-x-0 rounded-[10px] overflow-hidden`}>
          <DateRange
