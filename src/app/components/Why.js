    ...
    <section className="section flex items-center" id="why">
      <div className="container mx-auto">
        <motion.h2
          ...
          Unmatched excellence and costomer satisfactionn
        </motion.h2>
        <motion.p
          ...
          Our dedication to providing exeptional services sets us apart from the
        ...
        <motion.div
          ...
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            ...
            <h3 className="h3">Rent simple and quichly</h3>
            <p className="hidden xl:flex">
              We prioritize your need and we go about and beyoud to ensure your
